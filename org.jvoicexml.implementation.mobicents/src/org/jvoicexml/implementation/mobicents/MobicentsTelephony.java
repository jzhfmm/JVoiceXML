 ...
 * @since 0.6
 */
public final class MobicentsTelephony implements CallControlImplementation, CallControlImplementationListener,CallObserver {
     ...
     * this will be related to the {@link UserInputImplementation} implementation. In
...
//            Thread.sleep(10000);
     ...
     *
     * This implementation uses
     * {@link UserInputImplementation#getUriForNextSpokenInput()} to obtain
...
//        terminal.record(uri, null);
    ...
    protected void fireAnswerEvent() {
        final Collection<CallControlImplementationListener> tmp =
                new java.util.ArrayList<CallControlImplementationListener>(callControlListeners);
