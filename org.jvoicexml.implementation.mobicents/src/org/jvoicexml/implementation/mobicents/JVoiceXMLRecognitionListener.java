...
public final class JVoiceXMLRecognitionListener implements ResultListener {
	...
	private MobicentsSpokenInput input;
	 ...
	 *            the related spoken input device.
	 */
	public JVoiceXMLRecognitionListener(final MobicentsSpokenInput spokenInput) {
		input = spokenInput;
	}
	...
	public void resultAccepted(final ResultEvent resultEvent) {
		...
		final RecognitionResult recognitionResult = new MobicentsRecognitionResult(
				result);
