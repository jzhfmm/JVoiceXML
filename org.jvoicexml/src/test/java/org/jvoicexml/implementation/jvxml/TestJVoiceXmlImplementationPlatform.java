...
public final class TestJVoiceXmlImplementationPlatform {
    ...
    public void setUp() throws Exception, NoresourceError {
        ...
        final ResourceFactory<UserInputImplementation> spokenInputFactory =
            Mockito.mock(ResourceFactory.class);
        Mockito.when(spokenInputFactory.getInstances()).thenReturn(1);
        final UserInputImplementation input = Mockito.mock(UserInputImplementation.class);
    ...
    public void testTelephonyCallHungup() {
        final CallControlImplementation telephony = Mockito.mock(CallControlImplementation.class);
        final CallControlImplementationEvent event =
                new CallControlImplementationEvent(telephony, CallControlImplementationEvent.HUNGUP);
